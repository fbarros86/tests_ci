...
proof. 
  ...
  wp; sp; ecall (Fq_avx2_red.barret_red16x_corr_hh (Fq_avx2.lift_array16 r)). auto => />.
  move => &hr i_lb i_rub rp_sbred rp_eq__rp qx16_def vx16_def i_ub result red16x_bred.
  split; first by move : i_lb i_ub => /#.
  pose rp_sub := ((Fq_avx2_red.lift_array16
                       (lift2poly
...
proof. 
  ...
  rewrite mapiE //.
  sp. wp.
  ecall (Fq_avx2.fqmulx16_corr_hh (Fq_avx2_red.lift_array16 t) (Fq_avx2.lift_array16 dmontx16)).
  auto => />.
